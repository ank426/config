...
set --global fish_color_end brred
...
set --global fish_color_redirection normal
set --global fish_color_search_match --background=brcyan
set --global fish_color_selection --background=brcyan
